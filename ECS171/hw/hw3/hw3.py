...
# The baseline prediction performance is the combination classifier will perform better than the individual ones, which means AUC large than 0.84, and AUPRC large than 0.32.
# 
# The AUC are 0.84 and 0.87 individually, while the combination is 0.79. The AUPRC are 0.32 and 0.62 individually, while the combination is 0.20. These results indicate that this combination prediction is not as good as two individual predictors. So we reject the hypothesis, meaing combination performs worse.
