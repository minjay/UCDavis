...
public:
  ...
  InternalNode* mergeLeft(InternalNode* sibling);
  InternalNode* mergeRight(InternalNode* sibling);
  void removeFromThis(BTreeNode *ptr, int pos);
  BTreeNode* removePtr(int pos);
  void borrowFromLeft();
